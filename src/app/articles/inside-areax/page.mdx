...
export const article = {
  ...
  date: '2019-06-01',
  title: 'CNBC: AreaX the elite team product development team at JPMorgan',
  description:
    'Inside the rapid-response innovation team quickly bringing ideas to life and making faster decisions on which projects to pursue',
}
